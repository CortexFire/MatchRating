...
const matches = [
  {
    ...
    status: "pending_confirmation" as const, submittedAt: "2026-08-07T20:00:00.000Z", format: "singles" as const,
  ...
  {
    id: "match-2", groupId: "group-1", groupName: "Club", revisionId: "revision-2", submittedByUserId: "cory",
    status: "disputed" as const, submittedAt: "2026-08-06T20:00:00.000Z", format: "doubles" as const,
    ...
    ratingSummary: "Ratings updating…", canReview: false, canRevise: false,
  },
];
