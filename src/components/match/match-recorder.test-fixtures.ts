...
export const matchRecorderPlayers = [
  { id: "alice", name: "Alice Tan", initials: "AT", role: "Owner", rating: 1684, rd: 61, rank: 1, gamesPlayed: 26, status: "Pending review" },
  ...
  { id: "emi", name: "Emi Wilson", initials: "EW", role: "Member", rating: 1502, rd: 111, rank: 5, gamesPlayed: 11, status: "Pending review" },
