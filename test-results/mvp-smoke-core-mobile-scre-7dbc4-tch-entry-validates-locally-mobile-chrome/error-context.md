...
- Name: mvp-smoke.spec.ts >> core mobile screens render and match entry validates locally
- Location: tests\e2e\mvp-smoke.spec.ts:3:5
...
Locator: getByRole('heading', { name: 'Alice Tan' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Alice Tan' })
